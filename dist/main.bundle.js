...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_data_data_service__ = __webpack_require__("./src/app/services/data/data.service.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3_ng2_bootstrap_modal__["BootstrapModalModule"].forRoot({ container: document.body }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_rhythms_rhythms_component__ = __webpack_require__("./src/app/components/rhythms/rhythms.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_schedule_schedule_component__ = __webpack_require__("./src/app/components/schedule/schedule.component.ts");
...
module.exports = "<div class=\"container\">\n\n  <div class=\"row\">\n    <div class=\"col-lg-12\">\n      Name:\n      <input class=\"form-control\" [(ngModel)]=\"name\">\n    </div>\n  </div>\n\n  <div class=\"row\">\n      <div class=\"col-lg-12\">\n        Password:\n        <input class=\"form-control\" type=\"password\" [(ngModel)]=\"password\">\n      </div>\n  </div>\n\n  <br>\n\n  <div class=\"row\">\n    <div class=\"col-lg-12\">\n      <button type=\"button\" class=\"btn btn-default inl\" (click)=\"loginUser()\">Login</button>\n      <div routerLink=\"/register\" class=\"inl\">Don't have an account?</div>\n    </div>\n  </div>\n  \n</div>\n"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(_dataService, router, currentUser) {
        this._dataService = _dataService;
        this.router = router;
        this.currentUser = currentUser;
        this.isValid = false;
    ...
    LoginComponent.prototype.loginUser = function () {
        var _this = this;
        var user = new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](this.name, this.password, "");
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_data_data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */], __WEBPACK_IMPORTED_MODULE_4__models_CurrentUser__["a" /* CurrentUserModel */]])
    ], LoginComponent);
...
module.exports = "<div class=\"container\">\n  \n  <div class=\"row\">\n    <div class=\"col-lg-12\">\n      Name:\n      <input class=\"form-control\" [(ngModel)]=\"name\">\n    </div>\n  </div>\n\n  <div class=\"row\">\n      <div class=\"col-lg-12\">\n        Password:\n        <input class=\"form-control\" type=\"password\" [(ngModel)]=\"password\">\n      </div>\n  </div>\n\n  <div class=\"row\">\n      <div class=\"col-lg-12\">\n        E-mail:\n        <input class=\"form-control\" [(ngModel)]=\"email\">\n      </div>\n  </div>\n\n  <br>\n\n  <div class=\"row\">\n    <div class=\"col-lg-12\">\n      <button type=\"button\" class=\"btn btn-default inl\" (click)=\"registerUser()\">Register</button>\n      <div routerLink=\"/login\" class=\"inl\">Already have an account?</div>\n    </div>\n  </div>\n  \n</div>\n"
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(_dataService, router, currentUser) {
        this._dataService = _dataService;
        this.router = router;
        this.currentUser = currentUser;
        this.isValid = false;
    ...
    RegisterComponent.prototype.registerUser = function () {
        var _this = this;
        var user = new __WEBPACK_IMPORTED_MODULE_3__models_User__["a" /* User */](this.name, this.password, this.email);
...
/***/ "./src/app/components/rhythms/rhythms.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RhythmsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_time_time_service__ = __webpack_require__("./src/app/services/time/time.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_CurrentUser__ = __webpack_require__("./src/app/models/CurrentUser.ts");
...
var RhythmsComponent = /** @class */ (function () {
    function RhythmsComponent(_time, currentUser, _dataService) {
        this._time = _time;
        this.currentUser = currentUser;
        this._dataService = _dataService;
        this.timesShow = ["12am", "2am", "4am", "6am", "8am", "10am", "12pm", "2pm", "4pm", "6pm", "8pm", "10pm", "12am"];
        this.valuesShow = [90, 70, 53, 100, 120, 132, 115, 100, 100, 107, 111, 103, 90];
        this.times = [];
        this.timeTitles = [];
        this.values = [90, 85, 80, 75, 70, 65, 60, 56, 53, 70, 80, 90, 100, 105,
    ...
    RhythmsComponent.prototype.ngAfterViewInit = function () {
        ...
        var myChart = new __WEBPACK_IMPORTED_MODULE_1_chart_js__["Chart"](this.ctx, {
            type: 'line',
            data: {
    ...
    RhythmsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'rhythms',
            template: __webpack_require__("./src/app/components/rhythms/rhythms.component.html"),
            styles: [__webpack_require__("./src/app/components/rhythms/rhythms.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_time_time_service__["a" /* TimeService */], __WEBPACK_IMPORTED_MODULE_3__models_CurrentUser__["a" /* CurrentUserModel */], __WEBPACK_IMPORTED_MODULE_4__services_data_data_service__["a" /* DataService */]])
    ], RhythmsComponent);
    return RhythmsComponent;
}());
...
var ScheduleComponent = /** @class */ (function () {
    ...
    ScheduleComponent.prototype.generate = function () {
        ...
        this._dataService.generateSchedule(this.currentUser.name, this.cb1, this.cb2)
            ...
            _this.statusClass = "animated fadeOut";
            setTimeout(function () {
                _this.statusClass = "hiddn";
                _this.status = "";
            }, 3000);
        });
    };
...
var TasksComponent = /** @class */ (function () {
    ...
    TasksComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_data_data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_1_ng2_bootstrap_modal__["DialogService"], __WEBPACK_IMPORTED_MODULE_4__models_CurrentUser__["a" /* CurrentUserModel */], __WEBPACK_IMPORTED_MODULE_5__services_time_time_service__["a" /* TimeService */]])
    ], TasksComponent);
...
var DataService = /** @class */ (function () {
    function DataService(_http, currentUser) {
        this._http = _http;
        this.currentUser = currentUser;
        this.isValid = false;
    }
    ...
    DataService.prototype.addTask = function (title, priority, time, startTime, divisible, username) {
        this._http.post("/api/tasksAdd/" + username, {
            ...
            priority: priority,
            status: 0,
            id: __WEBPACK_IMPORTED_MODULE_3_angular2_uuid__["UUID"].UUID(),
            time: time,
            startTime: startTime,
            divisible: divisible
        })
    ...
    // Delete task
    DataService.prototype.deleteTask = function (id, username) {
    ...
    DataService.prototype.updateTask = function (id, status, username) {
    ...
    DataService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_4__models_CurrentUser__["a" /* CurrentUserModel */]])
    ], DataService);
    return DataService;
}());
